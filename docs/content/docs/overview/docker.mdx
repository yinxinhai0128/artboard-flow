---
title: Docker 部署
description: 使用 Docker Compose 部署 ArtboardFlow
---
...
```bash
git clone git@github.com:yinxinhai0128/artboard-flow.git
cd artboard-flow
docker compose up -d
```
...
services:
  app:
    image: ghcr.io/yinxinhai0128/artboard-flow:latest
    ports:
      - "3000:3000"
    environment:
...
docker run -d -p 3000:3000 \
  ...
  ghcr.io/yinxinhai0128/artboard-flow:latest
```
