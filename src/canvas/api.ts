import type { CanvasAssetRecord, CanvasAssetUpload, CanvasGenerationJob, CanvasGenerationPayload, CanvasProject } from './types'
...
export const canvasApi = {
  ...
  listAssets: () => request<CanvasAssetRecord[]>('/api/assets'),
