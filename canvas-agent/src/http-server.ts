...
export function startHttpServer() {
    ...
    app.listen(port, "127.0.0.1", () => {
        console.log("ArtboardFlow Agent");
        console.log(`Local URL: ${config.url}`);
        console.log(`Connect token: ${config.token}`);
        console.log("Codex MCP is not installed by this command.");
        console.log("Optional MCP add: codex mcp add artboard-flow -- npx -y @yinxinhai0128/artboard-flow-agent mcp");
        console.log("Remove manually added MCP: codex mcp remove artboard-flow");
    });
}
